...
- Карта и выбор полей сохраняют прежний сценарий. Последнее согласованное изменение — компактная правая панель: NDVI и один погодный график с переключателем, общая дата наведения, четыре показателя; Z и исходные данные раскрываются в «Данные и расчёт».
