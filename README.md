...
[правилам публичного Nominatim](https://operations.osmfoundation.org/policies/nominatim/), запросы
...
Проверки и запуск e2e — [tests/e2e/README.md](tests/e2e/README.md).
...
На экране поля слева — графики NDVI и погоды с переключателем, справа — периоды, когда поле отставало.
Сверху — светофор поля, последнее наблюдение NDVI, осадки, накопленное тепло и сухой период.
