...
Карта и выбор полей сохранены слева. Справа одновременно видны большой NDVI и один погодный график
с переключателем; сверху — последнее наблюдение NDVI, осадки, накопленное тепло и сухой период.
