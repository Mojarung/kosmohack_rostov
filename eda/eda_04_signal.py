...
ax.legend(frameon=False); fig.tight_layout(); fig.savefig('eda/figures/seasonal_profile_by_crop.png', dpi=130); plt.close(fig)
...
fig.tight_layout(); fig.savefig('eda/figures/sensor_bias.png', dpi=130); plt.close(fig)
...
fig.tight_layout(); fig.savefig('eda/figures/example_polygon_2021.png', dpi=130); plt.close(fig)
...
fig.tight_layout(); fig.savefig('eda/figures/anomaly_share_by_year.png', dpi=130); plt.close(fig)
...
fig.tight_layout(); fig.savefig('eda/figures/baseline_errors.png', dpi=130); plt.close(fig)
...
fig.tight_layout(); fig.savefig('eda/figures/test_gaps_by_year.png', dpi=130); plt.close(fig)
print('figures saved')
