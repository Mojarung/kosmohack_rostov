...
export function SatelliteArt({ size = 48, tone = "#e1f3fe", className, style, title }: ArtProps) {
  return (
    <svg {...frame(size, title)} className={className} style={style}>
      {title ? <title>{title}</title> : null}
      <circle cx="33" cy="14" r="9" fill={tone} />
...
export function FieldArt({ size = 48, tone = "#edf3ec", className, style, title }: ArtProps) {
  return (
    <svg {...frame(size, title)} className={className} style={style}>
      {title ? <title>{title}</title> : null}
      <path d="M30 8h12v13H30z" fill={tone} />
...
export function CurveArt({ size = 48, tone = "#fdebec", className, style, title }: ArtProps) {
  return (
    <svg {...frame(size, title)} className={className} style={style}>
      {title ? <title>{title}</title> : null}
      <rect x="26" y="14" width="12" height="22" rx="2" fill={tone} />
...
export function DroughtArt({ size = 48, tone = "#fbf3db", className, style, title }: ArtProps) {
  return (
    <svg {...frame(size, title)} className={className} style={style}>
      {title ? <title>{title}</title> : null}
      <circle cx="16" cy="15" r="9" fill={tone} />
...
export function SproutArt({ size = 48, tone = "#edf3ec", className, style, title }: ArtProps) {
  return (
    <svg {...frame(size, title)} className={className} style={style}>
      {title ? <title>{title}</title> : null}
      <circle cx="31" cy="17" r="9" fill={tone} />
...
export function GapArt({ size = 48, tone = "#e1f3fe", className, style, title }: ArtProps) {
  return (
    <svg {...frame(size, title)} className={className} style={style}>
      {title ? <title>{title}</title> : null}
      <circle cx="34" cy="30" r="8" fill={tone} />
      <path
        {...stroke}
...
export function LayersArt({ size = 48, tone = "#efeae0", className, style, title }: ArtProps) {
  return (
    <svg {...frame(size, title)} className={className} style={style}>
      {title ? <title>{title}</title> : null}
      <path d="M24 4 44 14 24 24 4 14z" fill={tone} />
...
export function SearchFieldsArt({ size = 48, tone = "#e1f3fe", className, style, title }: ArtProps) {
  return (
    <svg {...frame(size, title)} className={className} style={style}>
      {title ? <title>{title}</title> : null}
